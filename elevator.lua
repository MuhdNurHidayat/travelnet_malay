...
minetest.register_node("travelnet_malay:elevator", {
	description = "Lif",
	drawtype = "mesh",
	...
	local meta = minetest.get_meta(pos);
        meta:set_string("infotext",       "Lif (belum ditetapkan)");
        ...
        meta:set_string("formspec", 
                            "size[12,10]"..
                            "field[0.3,5.6;6,0.7;station_name;Nama stesen ini:;]"..
--                            "field[0.3,6.6;6,0.7;station_network;Masukkan ke Jaringan:;]"..
--                            "field[0.3,7.6;6,0.7;owner_name;(pilihan) dimiliki oleh:;]"..
                            "button_exit[6.3,6.2;1.7,0.7;station_set;Simpan]" );

       local p = {x=pos.x, y=pos.y+1, z=pos.z}
       local p2 = minetest.dir_to_facedir(placer:get_look_dir())
       minetest.add_node(p, {name="travelnet_malay:elevator_top", paramtype2="facedir", param2=p2})
    end,
    ...
    on_place = function(itemstack, placer, pointed_thing)
       ...
       if( node ~= nil and node.name ~= "air" and node.name ~= 'travelnet_malay:elevator_top') then
          minetest.chat_send_player( placer:get_player_name(), 'Tak cukup ruang menegak untuk meletakkan kotak lif!' )
          return;
       end
...
minetest.register_alias("travelnet_malay:elevator_top", "air")

--if( minetest.get_modpath("technic") ~= nil ) then
--        minetest.register_craft({
--                output = "travelnet_malay:elevator",
--		recipe = {
