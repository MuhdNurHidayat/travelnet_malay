...
-- Autor: Sokomine
minetest.register_node("travelnet_malay:travelnet", {

	description = "Kotak Travelnet",
	...
	local meta = minetest.get_meta(pos);
        ...
        meta:set_string("formspec", 
                            ...
                            "field[0.3,6.6;6,0.7;station_network;Sambungkan ke jaringan:;]"..
    ...
    on_place = function(itemstack, placer, pointed_thing)
       ...
       if( minetest.get_node({x=pos.x, y=pos.y+1, z=pos.z}).name ~= "air" ) then
          ...
          minetest.chat_send_player( placer:get_player_name(), 'Tidak cukup ruangan menegak untuk meletakkan kotak travelnet!' )
          return;
       end
...
minetest.register_craft({
        output = "travelnet_malay:travelnet",
